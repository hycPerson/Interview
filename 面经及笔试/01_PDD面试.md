...
## 滑动窗口
参考https://github.com/CyC2018/Interview-Notebook/blob/master/notes/%E8%AE%A1%E7%AE%97%E6%9C%BA%E7%BD%91%E7%BB%9C.md#tcp-%E6%BB%91%E5%8A%A8%E7%AA%97%E5%8F%A3
1、按序发送
2、窗口是缓存的一部分，用来暂时释放字节流。
3、发送方和接收方各有一个窗口。
4、接收窗口只会对窗口内最后一个按序到达的字节进行确认。
5、作用：控制发送方发送速率
